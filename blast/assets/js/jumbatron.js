...
var jumbotron = {
  ...
  containerBefore: {
    visible: function () {
      ...
      $jumbotronContainerBefore.delay(300).animate(
        {
          width: '5px',
          opacity: 1,
        },
  ...
  footer: {
    visible: function () {
      $jumbotronFooter.delay(600).animate(
        {
          opacity: 1,
        },
        {
